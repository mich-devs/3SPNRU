...
defaultproperties
{
     ...
     InfoText(78)="  * Horst & InhumanAimz for their work "
     InfoText(79)="  * Hv, f00l, Mythic, Nolja for the 3SPN RU Version "
     InfoText(80)="  * The RU Community for their testing, patience, and feedback."
     InfoText(81)=" "
     InfoText(82)="All without whom this mutator and its adjustments would not be possible!"
}
