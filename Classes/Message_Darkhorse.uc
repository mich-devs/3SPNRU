	...
	)
{
    if(SwitchNum == 1)
        ...
        return default.PlayerIsDarkHorseOpen @ Misc_PRI(RelatedPRI_1).GetColoredNameEx() @ default.PlayerIsDarkHorse;
}
...
defaultproperties
{
     DarkhorseSound=Sound'3SPNv3177AT.Sounds.DarkHorse'
