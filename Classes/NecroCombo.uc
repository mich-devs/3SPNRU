...
var()  string PropsDisplayText[6];
var()  string PropsDescText[6];
...
function Abort (bool bEndOfRoundError)
{
  ...
  {
    PlaySound(Sound'fart', SLOT_None, 300.0);
  }
...
static function FillPlayInfo (PlayInfo PlayInfo)
{
  ...
  PlayInfo.AddSetting("3SPN Necro Combo","NecroScoreAward",Default.PropsDisplayText[i++ ],0,10,"Text");
  PlayInfo.AddSetting("3SPN Necro Combo","HealthOnResurrect",Default.PropsDisplayText[i++ ],0,10,"Text");
  PlayInfo.AddSetting("3SPN Necro Combo","ShieldOnResurrect",Default.PropsDisplayText[i++ ],0,10,"Text");
  PlayInfo.AddSetting("3SPN Necro Combo","bSacrificeHealth",Default.PropsDisplayText[i++ ],0,10,"Check");
  PlayInfo.AddSetting("3SPN Necro Combo","SacrificePercentage",Default.PropsDisplayText[i++ ],0,10,"Text");
  PlayInfo.AddSetting("3SPN Necro Combo","bShareHealth",Default.PropsDisplayText[i++ ],0,10,"Check");
}
