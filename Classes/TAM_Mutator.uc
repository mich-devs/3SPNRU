...
function InitWeapons(int AssaultAmmo,int AssaultGrenades,int BioAmmo,int ShockAmmo,int LinkAmmo,int MiniAmmo,int FlakAmmo,int RocketAmmo,int LightningAmmo)
{
    ...
    //    class'DamTypeShieldImpact'.default.WeaponClass = class'DamType_ShieldImpact';
...
defaultproperties
{
     ...
     NewNetWeaponClasses(0)=Class'3SPHorstALPHA001.NewNet_ShockRifle'
     NewNetWeaponClasses(1)=Class'3SPHorstALPHA001.NewNet_LinkGun'
     NewNetWeaponClasses(2)=Class'3SPHorstALPHA001.NewNet_MiniGun'
     NewNetWeaponClasses(3)=Class'3SPHorstALPHA001.NewNet_FlakCannon'
     NewNetWeaponClasses(4)=Class'3SPHorstALPHA001.NewNet_RocketLauncher'
     NewNetWeaponClasses(5)=Class'3SPHorstALPHA001.NewNet_SniperRifle'
     NewNetWeaponClasses(6)=Class'3SPHorstALPHA001.NewNet_BioRifle'
     NewNetWeaponClasses(7)=Class'3SPHorstALPHA001.NewNet_AssaultRifle'
     NewNetWeaponClasses(8)=Class'3SPHorstALPHA001.NewNet_ShieldGun'
     NewNetWeaponNames(0)="3SPHorstALPHA001.NewNet_ShockRifle"
     NewNetWeaponNames(1)="3SPHorstALPHA001.NewNet_LinkGun"
     NewNetWeaponNames(2)="3SPHorstALPHA001.NewNet_MiniGun"
     NewNetWeaponNames(3)="3SPHorstALPHA001.NewNet_FlakCannon"
     NewNetWeaponNames(4)="3SPHorstALPHA001.NewNet_RocketLauncher"
     NewNetWeaponNames(5)="3SPHorstALPHA001.NewNet_SniperRifle"
     NewNetWeaponNames(6)="3SPHorstALPHA001.NewNet_BioRifle"
     NewNetWeaponNames(7)="3SPHorstALPHA001.NewNet_AssaultRifle"
     NewNetWeaponNames(8)="3SPHorstALPHA001.NewNet_ShieldGun"
