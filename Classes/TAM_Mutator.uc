...
defaultproperties
{
     ...
     NewNetWeaponClasses(0)=Class'3SPNRU-B2.NewNet_ShockRifle'
     NewNetWeaponClasses(1)=Class'3SPNRU-B2.NewNet_LinkGun'
     NewNetWeaponClasses(2)=Class'3SPNRU-B2.NewNet_MiniGun'
     NewNetWeaponClasses(3)=Class'3SPNRU-B2.NewNet_FlakCannon'
     NewNetWeaponClasses(4)=Class'3SPNRU-B2.NewNet_RocketLauncher'
     NewNetWeaponClasses(5)=Class'3SPNRU-B2.NewNet_SniperRifle'
     NewNetWeaponClasses(6)=Class'3SPNRU-B2.NewNet_BioRifle'
     NewNetWeaponClasses(7)=Class'3SPNRU-B2.NewNet_AssaultRifle'
     NewNetWeaponClasses(8)=Class'3SPNRU-B2.NewNet_ShieldGun'
     NewNetWeaponNames(0)="3SPNRU-B2.NewNet_ShockRifle"
     NewNetWeaponNames(1)="3SPNRU-B2.NewNet_LinkGun"
     NewNetWeaponNames(2)="3SPNRU-B2.NewNet_MiniGun"
     NewNetWeaponNames(3)="3SPNRU-B2.NewNet_FlakCannon"
     NewNetWeaponNames(4)="3SPNRU-B2.NewNet_RocketLauncher"
     NewNetWeaponNames(5)="3SPNRU-B2.NewNet_SniperRifle"
     NewNetWeaponNames(6)="3SPNRU-B2.NewNet_BioRifle"
     NewNetWeaponNames(7)="3SPNRU-B2.NewNet_AssaultRifle"
     NewNetWeaponNames(8)="3SPNRU-B2.NewNet_ShieldGun"
