...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
    ...
    moEditBox(Controls[19]).SetText(string(TAM_GRI(PlayerOwner().Level.GRI).MaxAdrenaline));
...
function bool OnClick(GUIComponent C)
{
    ...
    if(C == Controls[1])
    {
        ...
        s = s$"?MaxAdrenaline="$moEditBox(Controls[19]).GetText();
...
defaultproperties
{
     Begin Object Class=GUIImage Name=TabBackground
         ...
         bNeverFocus=True
     End Object
     Controls(0)=GUIImage'3SPNv3177AT.Menu_TabAMAdmin.TabBackground'
     ...
     End Object
     Controls(1)=GUIButton'3SPNv3177AT.Menu_TabAMAdmin.SaveButton'
     ...
     End Object
     Controls(2)=GUIButton'3SPNv3177AT.Menu_TabAMAdmin.LoadButton'
     ...
     Begin Object Class=moComboBox Name=MapBox
         ...
         WinHeight=0.037500
     End Object
     Controls(3)=moComboBox'3SPNv3177AT.Menu_TabAMAdmin.MapBox'
     ...
     End Object
     Controls(4)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.HealthBox'
     ...
     Begin Object Class=moEditBox Name=ArmorBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(5)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.ArmorBox'
     ...
     Begin Object Class=moCheckBox Name=ChallengeCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(6)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.ChallengeCheck'
     ...
     Begin Object Class=moEditBox Name=MaxHealthBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(7)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.MaxHealthBox'
     ...
     Begin Object Class=moEditBox Name=MinsBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(8)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.MinsBox'
     ...
     Begin Object Class=moEditBox Name=OTDamBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(9)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.OTDamBox'
     ...
     Begin Object Class=moEditBox Name=OTIntBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(10)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.OTIntBox'
     ...
     Begin Object Class=moCheckBox Name=SpeedCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(11)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.SpeedCheck'
     ...
     Begin Object Class=moCheckBox Name=InvisCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(12)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.InvisCheck'
     ...
     Begin Object Class=moCheckBox Name=BerserkCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(13)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.BerserkCheck'
     ...
     Begin Object Class=moCheckBox Name=BoosterCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(14)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.BoosterCheck'
     ...
     Begin Object Class=moCheckBox Name=KickCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(15)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.KickCheck'
     ...
     Begin Object Class=moEditBox Name=CampBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(16)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.CampBox'
     ...
     Begin Object Class=moCheckBox Name=ForceCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(17)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.ForceCheck'
     ...
     Begin Object Class=moCheckBox Name=PickupCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(18)=moCheckBox'3SPNv3177AT.Menu_TabAMAdmin.PickupCheck'
     ...
     Begin Object Class=moEditBox Name=MaxAdren
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(19)=moEditBox'3SPNv3177AT.Menu_TabAMAdmin.MaxAdren'
