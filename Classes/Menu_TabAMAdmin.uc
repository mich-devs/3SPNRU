...
defaultproperties
{
     Begin Object Class=GUIImage Name=TabBackground
         ...
         bNeverFocus=True
     End Object
     Controls(0)=GUIImage'3SPHorstALPHA001.Menu_TabAMAdmin.TabBackground'
     ...
     End Object
     Controls(1)=GUIButton'3SPHorstALPHA001.Menu_TabAMAdmin.SaveButton'
     ...
     End Object
     Controls(2)=GUIButton'3SPHorstALPHA001.Menu_TabAMAdmin.LoadButton'
     ...
     Begin Object Class=moComboBox Name=MapBox
         ...
         WinHeight=0.037500
     End Object
     Controls(3)=moComboBox'3SPHorstALPHA001.Menu_TabAMAdmin.MapBox'
     ...
     End Object
     Controls(4)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.HealthBox'
     ...
     Begin Object Class=moEditBox Name=ArmorBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(5)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.ArmorBox'
     ...
     Begin Object Class=moCheckBox Name=ChallengeCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(6)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.ChallengeCheck'
     ...
     Begin Object Class=moEditBox Name=MaxHealthBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(7)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.MaxHealthBox'
     ...
     Begin Object Class=moEditBox Name=MinsBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(8)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.MinsBox'
     ...
     Begin Object Class=moEditBox Name=OTDamBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(9)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.OTDamBox'
     ...
     Begin Object Class=moEditBox Name=OTIntBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(10)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.OTIntBox'
     ...
     Begin Object Class=moCheckBox Name=SpeedCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(11)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.SpeedCheck'
     ...
     Begin Object Class=moCheckBox Name=InvisCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(12)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.InvisCheck'
     ...
     Begin Object Class=moCheckBox Name=BerserkCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(13)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.BerserkCheck'
     ...
     Begin Object Class=moCheckBox Name=BoosterCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(14)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.BoosterCheck'
     ...
     Begin Object Class=moCheckBox Name=KickCheck2
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(15)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.KickCheck2'
     ...
     Begin Object Class=moEditBox Name=CampBox
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(16)=moEditBox'3SPHorstALPHA001.Menu_TabAMAdmin.CampBox'
     ...
     Begin Object Class=moCheckBox Name=ForceCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(17)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.ForceCheck'
     ...
     Begin Object Class=moCheckBox Name=PickupCheck
         ...
         OnChange=Menu_TabAMAdmin.OnChange
     End Object
     Controls(18)=moCheckBox'3SPHorstALPHA001.Menu_TabAMAdmin.PickupCheck'
