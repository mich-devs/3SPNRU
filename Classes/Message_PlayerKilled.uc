...
{
    if(Misc_Player(P) == None || Misc_Player(P).bUseOldStyle || class<WeaponDamageType>(OptionalObject) == None || class<WeaponDamageType>(OptionalObject).default.WeaponClass == None)
