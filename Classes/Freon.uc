...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNCv42101.Freon_ComboSpeed";
...
defaultproperties
{
     ...
     TeleportSound=Sound'3SPNCv42101.Teleport'
     bDisableTeamCombos=False
     TeamAIType(0)=Class'3SPNCv42101.Freon_TeamAI'
     TeamAIType(1)=Class'3SPNCv42101.Freon_TeamAI'
     DefaultPlayerClassName="3SPNCv42101.Freon_Pawn"
     ScoreBoardType="3SPNCv42101.Freon_Scoreboard"
     HUDType="3SPNCv42101.Freon_HUD"
     MapListType="3SPNCv42101.MapListFreon"
     PlayerControllerClassName="3SPNCv42101.Freon_Player"
     GameReplicationInfoClass=Class'3SPNCv42101.Freon_GRI'
     GameName="Freon"
