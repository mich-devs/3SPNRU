...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNRU-B2.Freon_ComboSpeed";
...
defaultproperties
{
     ...
     TeleportSound=Sound'3SPNRU-B2.Teleport'
     bDisableTeamCombos=False
     TeamAIType(0)=Class'3SPNRU-B2.Freon_TeamAI'
     TeamAIType(1)=Class'3SPNRU-B2.Freon_TeamAI'
     DefaultPlayerClassName="3SPNRU-B2.Freon_Pawn"
     ScoreBoardType="3SPNRU-B2.Freon_Scoreboard"
     HUDType="3SPNRU-B2.Freon_HUD"
     MapListType="3SPNRU-B2.MapListFreon"
     PlayerControllerClassName="3SPNRU-B2.Freon_Player"
     GameReplicationInfoClass=Class'3SPNRU-B2.Freon_GRI'
     GameName="Freon"
