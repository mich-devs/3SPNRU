...
defaultproperties
{
     Begin Object Class=GUIImage Name=TabBackground
         ...
         bNeverFocus=True
     End Object
     Controls(0)=GUIImage'3SPHorstALPHA001.Menu_TabTAMAdmin.TabBackground'
     ...
     End Object
     Controls(1)=GUIButton'3SPHorstALPHA001.Menu_TabTAMAdmin.SaveButton'
     ...
     End Object
     Controls(2)=GUIButton'3SPHorstALPHA001.Menu_TabTAMAdmin.LoadButton'
     ...
     Begin Object Class=moComboBox Name=MapBox
         ...
         WinHeight=0.037500
     End Object
     Controls(3)=moComboBox'3SPHorstALPHA001.Menu_TabTAMAdmin.MapBox'
     ...
     End Object
     Controls(4)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.HealthBox'
     ...
     Begin Object Class=moEditBox Name=ArmorBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(5)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.ArmorBox'
     ...
     Begin Object Class=moCheckBox Name=ChallengeCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(6)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.ChallengeCheck'
     ...
     Begin Object Class=moEditBox Name=MaxHealthBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(7)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.MaxHealthBox'
     ...
     Begin Object Class=moEditBox Name=MinsBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(8)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.MinsBox'
     ...
     Begin Object Class=moEditBox Name=OTDamBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(9)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.OTDamBox'
     ...
     Begin Object Class=moEditBox Name=OTIntBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(10)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.OTIntBox'
     ...
     Begin Object Class=moCheckBox Name=TeamCombosCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(11)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.TeamCombosCheck'
     ...
     Begin Object Class=moCheckBox Name=SpeedCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(12)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.SpeedCheck'
     ...
     Begin Object Class=moCheckBox Name=InvisCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(13)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.InvisCheck'
     ...
     Begin Object Class=moCheckBox Name=BerserkCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(14)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.BerserkCheck'
     ...
     Begin Object Class=moCheckBox Name=BoosterCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(15)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.BoosterCheck'
     ...
     Begin Object Class=moCheckBox Name=KickCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(16)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.KickCheck'
     ...
     Begin Object Class=moEditBox Name=CampBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(17)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.CampBox'
     ...
     Begin Object Class=moCheckBox Name=ForceCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(18)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.ForceCheck'
     ...
     Begin Object Class=moCheckBox Name=PickupCheck
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(19)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.PickupCheck'
     ...
     Begin Object Class=moEditBox Name=TOBox
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(20)=moEditBox'3SPHorstALPHA001.Menu_TabTAMAdmin.TOBox'
     ...
     Begin Object Class=moCheckBox Name=KickCheck2
         ...
         OnChange=Menu_TabTAMAdmin.OnChange
     End Object
     Controls(21)=moCheckBox'3SPHorstALPHA001.Menu_TabTAMAdmin.KickCheck2'
