...
{
    if(BlueTeamName != "")
        BlueTeamName = "3SPNCv42101.TAM_TeamInfoBlue";
...
{
    if(RedTeamName != "")
        RedTeamName = "3SPNCv42101.TAM_TeamInfoRed";
...
defaultproperties
{
     ...
     MaxHealth=1.250000
     bForceRespawn=True
     MapListType="3SPNCv42101.MapListTeamArenaMaster"
     MaxLives=1
     GameReplicationInfoClass=Class'3SPNCv42101.TAM_GRI'
     GameName="TeamArenaMaster v42101"
     Acronym="TAM"
}
